...
# CONTAINER BACKUP Script v2.1.2
...
- Example notification:
  ...
  *HOST-1* / *Docker Backup Notification*
  ✅ Backup completed for stack: `stack1`
...
```shell
sudo tar -xzvf /path/to/backup/oring/stack1/volume1/volume1_250902-1900.tar.gz -C /destination/path
```
...
# Changelog
- 2025-11-05  v2.2.2  Recovery instructions
